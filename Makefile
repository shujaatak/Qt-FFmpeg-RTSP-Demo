#############################################################################
# Makefile for building: RTSPClient
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  RTSPClient.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile RTSPClient.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L /usr/local/lib -lavcodec -lavformat -lswscale -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread -L/usr/X11R6/lib64
AR            = ar cqs
RANLIB        = 
...
$(TARGET): ui_login.h ui_video.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: RTSPClient.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile RTSPClient.pro
...
dist: 
	@test -d .tmp/RTSPClient1.0.0 || mkdir -p .tmp/RTSPClient1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/RTSPClient1.0.0/ && $(COPY_FILE) --parents FFmpeg.h login.h video.h .tmp/RTSPClient1.0.0/ && $(COPY_FILE) --parents main.cpp FFmpeg.cpp login.cpp video.cpp .tmp/RTSPClient1.0.0/ && $(COPY_FILE) --parents login.ui video.ui .tmp/RTSPClient1.0.0/ && (cd `dirname .tmp/RTSPClient1.0.0` && $(TAR) RTSPClient1.0.0.tar RTSPClient1.0.0 && $(COMPRESS) RTSPClient1.0.0.tar) && $(MOVE) `dirname .tmp/RTSPClient1.0.0`/RTSPClient1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/RTSPClient1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_login.cpp moc_video.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_login.cpp moc_video.cpp
moc_login.cpp: /usr/include/qt5/QtWidgets/QDialog \
...
moc_video.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
		...
		video.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include video.h -o moc_video.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_login.h ui_video.h
compiler_uic_clean:
	-$(DEL_FILE) ui_login.h ui_video.h
ui_login.h: login.ui
